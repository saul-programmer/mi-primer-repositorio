...
<div class="container pt-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header text-center"><img src="{{ asset('img/sesion.png') }}" width="50" height="50"></div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Comentario') }}</label>

                                <div class="col-md-6">
                                    <textarea name="your-message"placeholder="Comentario" cols="40" rows="10" class="form-control wpcf7-textarea" aria-invalid="false"></textarea>
                                </div>
                            </div>
